...
public class DataAdapter extends RecyclerView.Adapter<DataAdapter.ViewHolder> {
    ...
    public DataAdapter(ArrayList<AndroidVersion> list,String city) {
        this.city = city;
        this.list = list;
    }
    ...
    public void onBindViewHolder(DataAdapter.ViewHolder viewHolder, int i) {
        ...
        viewHolder.max_temp.setText("Максимальная температура : " + list.get(i).MaxTemp());
        viewHolder.min_temp.setText("Минимальная температура : "+list.get(i).MinTemp());
        viewHolder.wind_speed.setText("Скорость ветра : " + list.get(i).WindSpeed());
